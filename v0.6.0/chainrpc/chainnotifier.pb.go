...
// source: v0.6.0/chainrpc/chainnotifier.proto
...
func (*ConfRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_3e4761c7f0b81984, []int{0}
}
...
func (*ConfDetails) Descriptor() ([]byte, []int) {
	return fileDescriptor_3e4761c7f0b81984, []int{1}
}
...
func (*Reorg) Descriptor() ([]byte, []int) {
	return fileDescriptor_3e4761c7f0b81984, []int{2}
}
...
func (*ConfEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_3e4761c7f0b81984, []int{3}
}
...
func (*Outpoint) Descriptor() ([]byte, []int) {
	return fileDescriptor_3e4761c7f0b81984, []int{4}
}
...
func (*SpendRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_3e4761c7f0b81984, []int{5}
}
...
func (*SpendDetails) Descriptor() ([]byte, []int) {
	return fileDescriptor_3e4761c7f0b81984, []int{6}
}
...
func (*SpendEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_3e4761c7f0b81984, []int{7}
}
...
func (*BlockEpoch) Descriptor() ([]byte, []int) {
	return fileDescriptor_3e4761c7f0b81984, []int{8}
}
...
func init() {
	proto.RegisterFile("v0.6.0/chainrpc/chainnotifier.proto", fileDescriptor_3e4761c7f0b81984)
}

var fileDescriptor_3e4761c7f0b81984 = []byte{
	...
	,
}
...
var _ChainNotifier_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "v0.6.0/chainrpc/chainnotifier.proto",
}
