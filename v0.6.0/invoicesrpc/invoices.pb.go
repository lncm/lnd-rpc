...
// source: v0.6.0/invoicesrpc/invoices.proto
...
import (
	...
	lnrpc "github.com/lncm/lnd-rpc/v0.6.0/lnrpc"
...
func (*CancelInvoiceMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_7e6b15ec209d9b5c, []int{0}
}
...
func (*CancelInvoiceResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_7e6b15ec209d9b5c, []int{1}
}
...
func (*AddHoldInvoiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7e6b15ec209d9b5c, []int{2}
}
...
func (*AddHoldInvoiceResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_7e6b15ec209d9b5c, []int{3}
}
...
func (*SettleInvoiceMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_7e6b15ec209d9b5c, []int{4}
}
...
func (*SettleInvoiceResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_7e6b15ec209d9b5c, []int{5}
}
...
func init() { proto.RegisterFile("v0.6.0/invoicesrpc/invoices.proto", fileDescriptor_7e6b15ec209d9b5c) }

var fileDescriptor_7e6b15ec209d9b5c = []byte{
	...
	,
}
...
var _Invoices_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "v0.6.0/invoicesrpc/invoices.proto",
}
