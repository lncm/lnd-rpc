...
_ADDHOLDINVOICEREQUEST.fields_by_name['route_hints'].message_type = lnrpc_dot_rpc__pb2._ROUTEHINT
...
CancelInvoiceMsg = _reflection.GeneratedProtocolMessageType('CancelInvoiceMsg', (_message.Message,), dict(
  ...
  __module__ = 'invoicesrpc.invoices_pb2'
...
_INVOICES = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    input_type=lnrpc_dot_rpc__pb2._PAYMENTHASH,
    output_type=lnrpc_dot_rpc__pb2._INVOICE,
    serialized_options=None,
  ),
  _descriptor.MethodDescriptor(
    name='CancelInvoice',
