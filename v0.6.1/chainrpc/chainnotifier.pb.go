...
// source: v0.6.1/chainrpc/chainnotifier.proto
...
func (*ConfRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_dfc628644691101a, []int{0}
}
...
func (*ConfDetails) Descriptor() ([]byte, []int) {
	return fileDescriptor_dfc628644691101a, []int{1}
}
...
func (*Reorg) Descriptor() ([]byte, []int) {
	return fileDescriptor_dfc628644691101a, []int{2}
}
...
func (*ConfEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_dfc628644691101a, []int{3}
}
...
func (*Outpoint) Descriptor() ([]byte, []int) {
	return fileDescriptor_dfc628644691101a, []int{4}
}
...
func (*SpendRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_dfc628644691101a, []int{5}
}
...
func (*SpendDetails) Descriptor() ([]byte, []int) {
	return fileDescriptor_dfc628644691101a, []int{6}
}
...
func (*SpendEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_dfc628644691101a, []int{7}
}
...
func (*BlockEpoch) Descriptor() ([]byte, []int) {
	return fileDescriptor_dfc628644691101a, []int{8}
}
...
func init() {
	proto.RegisterFile("v0.6.1/chainrpc/chainnotifier.proto", fileDescriptor_dfc628644691101a)
}

var fileDescriptor_dfc628644691101a = []byte{
	...
	0x09, 0x29, 0x94, 0x82, 0x10, 0x6f, 0x48, 0x2b, 0x43, 0xed, 0xcb, 0x90, 0xb2, 0xbd, 0x47, 0x59,
	...
	0x37, 0x15, 0xfc, 0x13, 0x7b, 0xfb, 0x3b, 0x00, 0x00, 0xff, 0xff, 0xfc, 0xee, 0xa4, 0xc5, 0xeb,
	0x04, 0x00, 0x00,
}
...
var _ChainNotifier_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "v0.6.1/chainrpc/chainnotifier.proto",
}
