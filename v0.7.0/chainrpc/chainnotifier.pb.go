...
// source: v0.7.0/chainrpc/chainnotifier.proto
...
func (*ConfRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_19f68742f0e3fdcc, []int{0}
}
...
func (*ConfDetails) Descriptor() ([]byte, []int) {
	return fileDescriptor_19f68742f0e3fdcc, []int{1}
}
...
func (*Reorg) Descriptor() ([]byte, []int) {
	return fileDescriptor_19f68742f0e3fdcc, []int{2}
}
...
func (*ConfEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_19f68742f0e3fdcc, []int{3}
}
...
func (*Outpoint) Descriptor() ([]byte, []int) {
	return fileDescriptor_19f68742f0e3fdcc, []int{4}
}
...
func (*SpendRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_19f68742f0e3fdcc, []int{5}
}
...
func (*SpendDetails) Descriptor() ([]byte, []int) {
	return fileDescriptor_19f68742f0e3fdcc, []int{6}
}
...
func (*SpendEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_19f68742f0e3fdcc, []int{7}
}
...
func (*BlockEpoch) Descriptor() ([]byte, []int) {
	return fileDescriptor_19f68742f0e3fdcc, []int{8}
}
...
func init() {
	proto.RegisterFile("v0.7.0/chainrpc/chainnotifier.proto", fileDescriptor_19f68742f0e3fdcc)
}

var fileDescriptor_19f68742f0e3fdcc = []byte{
	...
	0xb1, 0x4a, 0x48, 0xa1, 0x2a, 0x48, 0xf0, 0x86, 0xb4, 0x32, 0xd4, 0xbe, 0x0c, 0x29, 0xdb, 0x7b,
	...
	0x74, 0x6e, 0xab, 0xf8, 0x27, 0xf6, 0xe6, 0x57, 0x00, 0x00, 0x00, 0xff, 0xff, 0x2c, 0xe3, 0x3f,
	0x36, 0xeb, 0x04, 0x00, 0x00,
}
...
var _ChainNotifier_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "v0.7.0/chainrpc/chainnotifier.proto",
}
