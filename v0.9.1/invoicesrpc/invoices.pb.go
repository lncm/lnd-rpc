...
// source: v0.9.1/invoicesrpc/invoices.proto
...
func (*CancelInvoiceMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_df74fcf615baa280, []int{0}
}
...
func (*CancelInvoiceResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_df74fcf615baa280, []int{1}
}
...
func (*AddHoldInvoiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_df74fcf615baa280, []int{2}
}
...
func (*AddHoldInvoiceResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_df74fcf615baa280, []int{3}
}
...
func (*SettleInvoiceMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_df74fcf615baa280, []int{4}
}
...
func (*SettleInvoiceResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_df74fcf615baa280, []int{5}
}
...
func (*SubscribeSingleInvoiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_df74fcf615baa280, []int{6}
}
...
func init() { proto.RegisterFile("v0.9.1/invoicesrpc/invoices.proto", fileDescriptor_df74fcf615baa280) }

var fileDescriptor_df74fcf615baa280 = []byte{
	...
	,
}
...
var _Invoices_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "v0.9.1/invoicesrpc/invoices.proto",
}
