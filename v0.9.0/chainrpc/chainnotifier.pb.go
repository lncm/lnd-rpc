...
// source: v0.9.0/chainrpc/chainnotifier.proto
...
func (*ConfRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f577cf353865ee61, []int{0}
}
...
func (*ConfDetails) Descriptor() ([]byte, []int) {
	return fileDescriptor_f577cf353865ee61, []int{1}
}
...
func (*Reorg) Descriptor() ([]byte, []int) {
	return fileDescriptor_f577cf353865ee61, []int{2}
}
...
func (*ConfEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_f577cf353865ee61, []int{3}
}
...
func (*Outpoint) Descriptor() ([]byte, []int) {
	return fileDescriptor_f577cf353865ee61, []int{4}
}
...
func (*SpendRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f577cf353865ee61, []int{5}
}
...
func (*SpendDetails) Descriptor() ([]byte, []int) {
	return fileDescriptor_f577cf353865ee61, []int{6}
}
...
func (*SpendEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_f577cf353865ee61, []int{7}
}
...
func (*BlockEpoch) Descriptor() ([]byte, []int) {
	return fileDescriptor_f577cf353865ee61, []int{8}
}
...
func init() {
	proto.RegisterFile("v0.9.0/chainrpc/chainnotifier.proto", fileDescriptor_f577cf353865ee61)
}

var fileDescriptor_f577cf353865ee61 = []byte{
	...
	0x17, 0xf7, 0x43, 0xff, 0xbd, 0x3f, 0x7c, 0x1d, 0x27, 0x11, 0xe3, 0x79, 0x16, 0xeb, 0x03, 0x4f,
	...
	0xd0, 0xb9, 0xad, 0xe2, 0x9f, 0xd8, 0x9b, 0x5f, 0x01, 0x00, 0x00, 0xff, 0xff, 0x2b, 0x4e, 0x33,
	0x2c, 0xeb, 0x04, 0x00, 0x00,
}
...
var _ChainNotifier_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "v0.9.0/chainrpc/chainnotifier.proto",
}
