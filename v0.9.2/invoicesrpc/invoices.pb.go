...
// source: v0.9.2/invoicesrpc/invoices.proto
...
func (*CancelInvoiceMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_65b5461258200f44, []int{0}
}
...
func (*CancelInvoiceResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_65b5461258200f44, []int{1}
}
...
func (*AddHoldInvoiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_65b5461258200f44, []int{2}
}
...
func (*AddHoldInvoiceResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_65b5461258200f44, []int{3}
}
...
func (*SettleInvoiceMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_65b5461258200f44, []int{4}
}
...
func (*SettleInvoiceResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_65b5461258200f44, []int{5}
}
...
func (*SubscribeSingleInvoiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_65b5461258200f44, []int{6}
}
...
func init() { proto.RegisterFile("v0.9.2/invoicesrpc/invoices.proto", fileDescriptor_65b5461258200f44) }

var fileDescriptor_65b5461258200f44 = []byte{
	...
	0x9b, 0x47, 0x6f, 0xa2, 0xc5, 0x8c, 0xb2, 0x1d, 0xa7, 0x29, 0x51, 0x52, 0xa4, 0xfb, 0x38, 0x12,
	...
	0x03, 0x00, 0x00, 0xff, 0xff, 0xf1, 0xfc, 0x0b, 0xce, 0x59, 0x04, 0x00, 0x00,
}
...
var _Invoices_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "v0.9.2/invoicesrpc/invoices.proto",
}
