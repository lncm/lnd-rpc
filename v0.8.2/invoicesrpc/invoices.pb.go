...
// source: v0.8.2/invoicesrpc/invoices.proto
...
func (*CancelInvoiceMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_762607261cf4d1c3, []int{0}
}
...
func (*CancelInvoiceResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_762607261cf4d1c3, []int{1}
}
...
func (*AddHoldInvoiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_762607261cf4d1c3, []int{2}
}
...
func (*AddHoldInvoiceResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_762607261cf4d1c3, []int{3}
}
...
func (*SettleInvoiceMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_762607261cf4d1c3, []int{4}
}
...
func (*SettleInvoiceResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_762607261cf4d1c3, []int{5}
}
...
func (*SubscribeSingleInvoiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_762607261cf4d1c3, []int{6}
}
...
func init() { proto.RegisterFile("v0.8.2/invoicesrpc/invoices.proto", fileDescriptor_762607261cf4d1c3) }

var fileDescriptor_762607261cf4d1c3 = []byte{
	// 512 bytes of a gzipped FileDescriptorProto
	,
}
...
var _Invoices_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "v0.8.2/invoicesrpc/invoices.proto",
}
